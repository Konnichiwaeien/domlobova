        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 xl:gap-12">
            ...
            <div className="space-y-8 flex flex-col justify-start">
               <div>
                 <span className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-black text-brand-orange mb-2.5 block opacity-90">Документы</span>
                 <button 
                   onClick={() => setShowRequisites(true)}
                   className="group flex items-center gap-3 text-brand-brown hover:text-brand-orange transition-colors cursor-pointer text-left focus:outline-none focus-visible:ring-4 focus-visible:ring-brand-orange/50 rounded-xl px-1 py-1 -ml-1"
                 >
                   <div className="w-8 h-8 md:w-10 md:h-10 shrink-0 rounded-full bg-brand-brown/5 group-hover:bg-brand-orange/10 flex items-center justify-center transition-colors">
                     <FileText className="w-4 h-4 md:w-5 md:h-5" />
                   </div>
                   <span className="font-bold underline decoration-brand-brown/20 group-hover:decoration-brand-orange/50 underline-offset-4 text-sm md:text-base">
                 ...
                 <div className="flex gap-3">
                  {socialLinks.map((social, sIdx) => (
                    <a 
                      ...
                      title={social.label}
                      className="w-10 h-10 md:w-12 md:h-12 rounded-xl border-2 border-brand-brown/10 text-brand-brown/80 flex items-center justify-center hover:bg-brand-orange hover:border-brand-orange hover:text-white transition-all duration-300 focus:outline-none focus-visible:ring-4 focus-visible:ring-brand-orange/50"
                    >
