            ...
            <div className="max-w-5xl w-full flex flex-col items-center justify-center h-full pt-20 pointer-events-auto">
              ...
              >
                ...
                <a
                  ...
                  className="flex flex-col items-center justify-center py-4 px-6 cursor-pointer group"
                >
                  <span className="text-white/80 font-semibold text-lg group-hover:text-white transition-colors duration-300">
                    Узнать больше
                  </span>
                  <svg
                    viewBox="0 0 160 10"
                    preserveAspectRatio="none"
                    className="w-full h-2 mt-1 text-white/40 group-hover:text-white/75 transition-colors duration-300"
                    aria-hidden="true"
                  >
                    <path
                      d="M2,7 C18,3 36,9 54,5.5 C72,2 90,8 110,5 C128,2 144,7.5 158,5.5"
                      stroke="currentColor"
                      strokeWidth="2.5"
                      fill="none"
                      strokeLinecap="round"
